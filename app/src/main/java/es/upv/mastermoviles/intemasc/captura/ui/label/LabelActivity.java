...
public class LabelActivity extends AppCompatActivity implements View.OnTouchListener {
   ...
   final static int MAX_LABEL = 12; //Número máximo de etiquetas que se admiten. Limitada por nú,ero de botones
   final static int BUTTON_ID[] = {R.id.btn_1, R.id.btn_2, R.id.btn_3, R.id.btn_4, R.id.btn_5, R.id.btn_6,
           R.id.btn_7, R.id.btn_8, R.id.btn_9, R.id.btn_10, R.id.btn_11, R.id.btn_12};
   final static int CIRCLES_ID[] = {R.id.txv_label1, R.id.txv_label2, R.id.txv_label3, R.id.txv_label4, R.id.txv_label5,
           R.id.txv_label6, R.id.txv_label7, R.id.txv_label8, R.id.txv_label9, R.id.txv_label10, R.id.txv_label11, R.id.txv_label12};
